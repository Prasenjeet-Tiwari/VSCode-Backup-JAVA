...
public class ancestor_Last_comn_ances {
...
//Optimized because no extra spaced is taken
    ...
    System.out.println("The (unoptimized code) lowest common ancestor : " + lca(root,4,5).data);
    System.out.println("The (optimized code) lowest common ancestor   : " + optimizedLca(root,4,7).data);
