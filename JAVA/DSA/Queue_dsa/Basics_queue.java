...
public class Basics_queue{
    ...
    /*Framework implementation should be in java
     * 
     * (Add from rear) , (peek and pop from front)
     * There is no "push()"" and "pop()" operation rather we have
     *      offer() which is similar to push()
     *      poll() which is similar to pop()
     *      peek() remains the same
     */
